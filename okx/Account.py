...
class AccountAPI(OkxClient):
    ...
    def get_max_avail_size(
        self, instId, tdMode, ccy="", reduceOnly="", unSpotOffset="", quickMgnType=""
    ):
        params = {
            "instId": instId,
            "tdMode": tdMode,
    ...
    def get_fix_loan_borrowing_quote(
        self, type=None, ccy=None, amt=None, maxRate=None, term=None, ordId=None
    ):
        params = {}
        if type is not None:
            params["type"] = type
    ...
    def amend_fix_loan_borrowing_order(
        self, ordId=None, reborrow=None, renewMaxRate=None
    ):
        params = {}
        if ordId is not None:
            params["ordId"] = ordId
