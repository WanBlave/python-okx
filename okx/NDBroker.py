...
class NDBrokerAPI(OkxClient):
    ...
    def create_subaccount_apikey(
        self, subAcct="", label="", passphrase="", ip="", perm=""
    ):
        params = {
            "subAcct": subAcct,
            "label": label,
    ...
    def set_subaccount_fee_rate(
        self, subAcct="", instType="", chgType="", chgTaker="", chgMaker="", effDate=""
    ):
        params = {
            "subAcct": subAcct,
            "instType": instType,
    ...
    def create_subaccount_deposit_address(
        self, subAcct="", ccy="", chain="", addrType="", to=""
    ):
        params = {
            "subAcct": subAcct,
            "ccy": ccy,
    ...
    def reset_subaccount_deposit_address(
        self, subAcct="", ccy="", chain="", addr="", to=""
    ):
        params = {
            "subAcct": subAcct,
            "ccy": ccy,
        ...
        return self._request_with_params(
            POST, MODIFY_SUBACCOUNT_DEPOSIT_ADDRESS, params
        )
